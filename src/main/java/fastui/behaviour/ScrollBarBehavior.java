...
public class ScrollBarBehavior implements MouseBehavior {
    ...
    public ScrollBarBehavior(final Component track, final ScrollListener listener) {
        this.track = track;
    ...
    public void onMouseDragged(final Component target, final int mx, final int my) {
        ...
        final float delta = (float)(mx - this.dragStartX) / this.track.getWidth();
        this.dragStartX = mx;
