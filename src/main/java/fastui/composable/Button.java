...
public class Button implements Composable {
    ...
    public Button(final float x, final float y, final float width, final float height,
                  final ButtonTheme theme, final String text, final Font font, final Color textColor) {
        this(x, y, width, height, theme.arc, theme.base, theme.hover, theme.pressed, text, font, textColor);
    }

    public Button(final float x, final float y, final float width, final float height,
                  final int arc, final Color baseColor,
    ...
    private Button(final float x, final float y, final float width, final float height,
                   final int arc, final Color baseColor, final Color hoverColor, final Color pressedColor,
                   final String text, final Font font, final Color textColor) {
