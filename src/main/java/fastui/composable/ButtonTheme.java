 ...
 * Encapsulates colors and rounding for all three states (Base, Hover, Pressed).
 */
public class ButtonTheme {
    ...
    /**
     * Explicitly defines a button theme.
     * No "magic" logic or automatic color offsets are applied.
     */
